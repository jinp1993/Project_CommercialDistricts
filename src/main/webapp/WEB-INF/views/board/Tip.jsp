			...
			<div class="row">
				<div class=" fh5co-service1">
					<div class="fh5co-desc2">
						...
						<h3>
							<a href="Tip" class="m-tcol-t1" title="팁&질문&답변">QA&TIP</a>
						</h3>
						...
						<div align="center">
							<ul class="ul">
								<c:if test="${pageMaker.prev}">
									<li><a class="title" href="Tip?board=Tip&page=${pageMaker.starPage - 1}">이전</a></li>
								</c:if>
								<c:forEach begin="${pageMaker.starPage}"
										...
										<li
											...
											<a class="title" href="Tip?board=Tip&page=${idx}">${idx}</a>
								...
								<c:if test="${pageMaker.next && pageMaker.endPage > 0 }">
									<li><a class="title"
										href="Tipe?board=Tip&page=${pageMaker.endPage + 1 }">다음</a></li>
								</c:if>
							</ul>
						</div>
					</div>
