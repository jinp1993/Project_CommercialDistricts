							...
							<ul class="subject">
								<li><div>
										<label for="boardCategory">게시판</label> <select name="menuid"
											style="width: 152px;" id="boardCategory">
											...
											<option value="Tip">Q&A/Tip</option>
										</select>
									</div></li>
								<li><div>
										<label for="subject">제목</label> <input type="text"
											name="title" placeholder="게시글 제목을 입력하세요" id="subject"
											style="width: 60%;">
									</div></li>
							</ul>
							<textarea id="textbox"
								style="visibility: visible; margin: 0 25px 0 25px; height: 300px; width: 90%;"
								name="content" title="내용 입력" cols="120" rows="28"></textarea>
						</div>
						<div align="center">
